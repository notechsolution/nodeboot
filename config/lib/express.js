...
module.exports.initStaticResource = function (app){
  ...
  var staticPath = path.posix.join(config.webpack.assetsPublicPath, config.webpack.assetsSubDirectory)
  app.use(staticPath, express.static('.'+config.webpack.assetsPublicPath+'/static'))
}
